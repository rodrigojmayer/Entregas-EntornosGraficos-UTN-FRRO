...
El codigo de contador.php lee el valor guardado en el archivo contador.dat, le suma uno, y sobrescribe con el nuevo valor. Lo muestra en pantalla.
El código de visitas.php llama al de contador.php. 
